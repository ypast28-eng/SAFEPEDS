-- =============================================================================
-- PEDSAFE — Complete Supabase Schema
-- Paste this entire script into the Supabase SQL Editor and run once.
--
-- Tables: profiles, compounds, cycles, bloodwork, lab_results, notes
-- Plus:   cycle_compounds (links cycles ↔ compounds)
--
-- Educational health monitoring only. Not medical advice.
-- =============================================================================
...
-- ─── cycle_compounds (compounds assigned to a cycle) ────────────────────────
...
-- ─── bloodwork (lab report / panel header) ───────────────────────────────────
...
-- ─── lab_results (individual marker results) ────────────────────────────────
...
-- ─── notes (user-owned, optionally linked) ──────────────────────────────────
...
-- ─── Auto-calculate lab result status ───────────────────────────────────────
...
-- compounds: all authenticated users can read; admins can manage catalog
...
-- cycle_compounds: via owning cycle
...
-- lab_results: via owning bloodwork report
...
-- ─── Seed starter compounds (optional) ──────────────────────────────────────
...
-- ─── Grant admin (run manually after signup) ────────────────────────────────
-- update public.profiles set is_admin = true where email = 'your-admin@email.com';

-- =============================================================================
-- Done. Verify in Table Editor: profiles, compounds, cycles, cycle_compounds,
-- bloodwork, lab_results, notes
-- =============================================================================
